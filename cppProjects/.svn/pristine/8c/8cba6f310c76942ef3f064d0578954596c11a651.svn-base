...
# CONFIGURATION
# ======================
CHECKPOINT_DIR = "./checkpoints_Treebind5"
TREE_BINDING_DIR = "./tree_binding_data5"
os.makedirs(CHECKPOINT_DIR, exist_ok=True)
os.makedirs(TREE_BINDING_DIR, exist_ok=True)

# Tree Binding Configuration
TREE_CONFIG = {
    'num_models': 6,           # Start with 10 models
    'keep_top': 2,              # Keep best 3 after each epoch
    'mutation_rate': 0.3,
...
class SimpleNN(nn.Module):
    def __init__(self, layer_config=None):
        ...
        # Changed configuration: 784-128-64-10 for speed
        default_config = { # CHANGE INTO 3 IF NEEDEED
            'layer_sizes': [784, 128, 128, 128, 10],  # Changed from [784, 128, 128, 128, 10]
            'activations': ['relu', 'relu', 'relu', None]  # Adjusted for smaller network
        }
...
def main():
    print("\n" + "="*60)
    print("TREE BINDING TRAINING WITH 784-128-64-10 NETWORK")
    print("="*60)
